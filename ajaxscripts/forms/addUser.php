...
<form autocomplete="off" id="addUserForm">
    <div class="card p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
        <h5 class="font-weight-bolder mb-0">Add System Users </h5>
		 ...
		 <div class="row mt-3">
			...
			<label for="address">Home Address</label>
                <input id="address" class="form-control" type="text" name="transactionDescription" placeholder="Enter address ">  
            </div>
       ...
       <input id="username" class="form-control" type="text" name="username" placeholder="Enter username" required>      
		...
		<div class="col-12 col-sm-4 mt-3 mt-sm-0">
        <button  style="width: 80% !important; float: left; margin-top: 0px;" id="saveUser" class="btn bg-gradient-dark mb-0 js-btn-next" type="button" title="Save Record">SAVE RECORD >> </button>    
		 </div>
