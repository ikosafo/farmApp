    ...
    <div class="card p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
        <h5 class="font-weight-bolder mb-0">Edit System Users </h5>
		 ...
		 <div class="row mt-3">
			...
			<input id="address" class="form-control" type="tel" name="address" placeholder="Enter address" value="<?php echo $resUser['address']; ?>">	
       ...
       <label for="username">Username</label>
		...
		<div class="col-12 col-sm-4 mt-3 mt-sm-0">
        <button  style="width: 80% !important; float: left; margin-top: 0px;" id="editUser" class="btn bg-gradient-dark mb-0 js-btn-next" type="button" title="Save Record">UPDATE RECORD >> </button>    
		 </div>
