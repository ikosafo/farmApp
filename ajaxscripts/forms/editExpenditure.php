        ...
        <p class="mb-0 text-sm">View farm expenditure</p>
		  ...
		  <div class="row mt-3">
            ...
            <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                ...
                <textarea id="expenditureDescription" class="form-control"  name="expenditureDescription" rows="1" placeholder="Enter expenditure description"><?php echo $resExp['expenditureDescription']; ?></textarea>
            </div>
		 ...
		 <div class="col-12 col-sm-3 mt-3 mt-sm-0">
			...
			<div class="col-12 col-sm-3 mt-3 mt-sm-0">
				...
				<button  style="width: 80% !important; float: left; margin-top: 30px;" id="editExpenditure" class="btn bg-gradient-dark mb-0 js-btn-next" type="button" title="Save Record">UPDATE RECORD >> </button>
