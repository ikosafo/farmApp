...
<form autocomplete="off" id="farmIncomeForm">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-md-6">
            <label for="expenditurePayer" class="form-label">Payer </label>
            <input id="expenditurePayer" class="form-control border-radius-md" type="text" placeholder="Enter Payer" required>
        </div>
    </div>
