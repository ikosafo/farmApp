...
$checkQuery = "SELECT COUNT(*) AS count FROM `prodcategory` WHERE `pcatStatus` = 1 AND `pcatName` = '$categoryName'";
...
if ($count > 0) {
    ...
    // Insert new category
    $insertQuery = "INSERT INTO `prodcategory` (`pcatName`, `pcatDesc`, `pcatStatus`) 
