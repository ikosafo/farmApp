...
try {
    ...
    $checkQuery = "SELECT COUNT(*) AS count FROM `categories` WHERE `categoryName` = ? AND `categoryStatus` = 1 AND `catId` != ?";
    ...
    $updateQuery = "UPDATE `categories` SET `categoryName` = ?, `categoryDescription` = ?, `categoryStatus` = ?, `updatedAt` = ? WHERE `catId` = ?";
