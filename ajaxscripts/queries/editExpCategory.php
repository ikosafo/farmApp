...
try {
    ...
    $checkQuery = "SELECT COUNT(*) AS count FROM `expCategory` WHERE `ecatName` = ? AND `ecatStatus` = 1 AND `ecatId` != ?";
    ...
    $updateQuery = "UPDATE `expCategory` SET `ecatName` = ?, `ecatDesc` = ?, `ecatStatus` = ?, `updatedAt` = ? WHERE `ecatId` = ?";
