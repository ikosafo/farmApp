...
try {
    ...
    $checkQuery = "SELECT COUNT(*) AS count FROM `prodcategory` WHERE `pcatName` = ? AND `pcatStatus` = 1 AND `pcatId` != ?";
    ...
    $updateQuery = "UPDATE `prodcategory` SET `pcatName` = ?, `pcatDesc` = ?, `pcatStatus` = ?, `updatedAt` = ? WHERE `pcatId` = ?";
