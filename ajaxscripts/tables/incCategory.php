<div class="table-responsive">
    <table class="table table-hover align-items-center mb-0" id="incCategory">
        <thead>
            <tr>
...
<script>
    var oTable = $('#incCategory').DataTable({
        stateSave: true,
        lengthChange: false,
        processing: true,
        serverSide: true,
        serverMethod: 'post',
        ajax: {
            url: 'ajaxscripts/paginations/incCategories.php'
        },
        columns: [
    ...
    $(document).off('click', '.deleteIncCategory').on('click', '.deleteIncCategory', function() {
        var theindex = $(this).attr('i_index');
        $.confirm({
            title: 'Delete Income Category',
            content: 'Are you sure you want to delete this income category?',
            theme: 'modern',
            buttons: {
                cancel: {
                    text: 'Cancel',
                ...
                confirm: {
                    ...
                    action: function() {
                        ...
                        var url = "ajaxscripts/queries/deleteIncCategory.php";
