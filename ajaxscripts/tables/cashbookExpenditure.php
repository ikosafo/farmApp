<div class="card" data-animation="FadeIn">
    <div class="row">
        <div class="col-12">
			...
			<thead>
				<tr>
					<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Expenditure Relates</th>
					...
					<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Cashbook Entry Type</th>
...
<script>
    oTable = $('#siteTable').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': 'ajaxscripts/paginations/cashbookExpenditure.php'
        },
        'columns': [{
    ...
    $(document).off('click', '.viewCashbookExp_btn').on('click', '.viewCashbookExp_btn', function() {
        var theindex = $(this).attr('i_index');
        //alert(theindex);
