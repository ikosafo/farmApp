...
// Pie Chart Data
$lineChartQuery = $mysqli->query("SELECT DATE_FORMAT(transactionDate, '%Y-%m') as month, SUM(ghsEquivalent) as total FROM `cashbook_transactions` WHERE transactionType = 'Payment' AND transStatus = 1 AND transactionDate >= DATE_SUB(CURDATE(), INTERVAL 12 MONTH) GROUP BY month ORDER BY month");
$lineChartLabels = [];
$lineChartData = [];
...
?>
    ...
    <!-- <style>
        ...
        #paymentsLineChart, #paymentsPieChart {
            min-height: 300px;
            width: 100%;
        }
...
<div class="statistics-container">
        ...
        <div class="col-12 col-md-4 col-lg-4">
            <div class="card shadow-sm border-radius-xl p-3 h-100">
                <div class="card-body text-center d-flex flex-column justify-content-center">
                    ...
                    <h6 class="font-weight-bolder">Total Payments</h6>
        ...
        <div class="col-12 col-md-4 col-lg-4">
            <div class="card shadow-sm border-radius-xl p-3 h-100">
                <div class="card-body text-center d-flex flex-column justify-content-center">
                    ...
                    <h6 class="font-weight-bolder">Average Payment</h6>
    ...
    <div class="row g-4 mb-4">
        <div class="col-12 col-lg-6">
            <div class="card shadow-sm border-radius-xl p-4">
                <h5 class="font-weight-bolder mb-3">Payments Over Time</h5>
                <canvas id="paymentsLineChart"></canvas>
            </div>
        </div>
        <div class="col-12 col-lg-6">
            <div class="card shadow-sm border-radius-xl p-4">
                <h5 class="font-weight-bolder mb-3">Payments by Nominal Account</h5>
    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="card shadow-sm border-radius-xl p-4">
                <h5 class="font-weight-bolder mb-3">Payments Summary</h5>
