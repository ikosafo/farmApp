...
## Fetch records
$empQuery = "SELECT * FROM `cashbook_transactions` WHERE `transStatus` = 1 AND `transactionType` = 'Receipt' AND 1 " . $searchQuery . " ORDER BY updatedAt DESC LIMIT " . $row . "," . $rowperpage;
