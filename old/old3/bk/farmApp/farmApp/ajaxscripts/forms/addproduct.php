...
<form autocomplete="off" id="addProductForm">
    <div class="card p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
        ...
        <p class="mb-0 text-sm">Add new farm product</p>

        <div class="row mt-3">
            <div class="col-12">
                <label for="productName">Product Name</label>
                <input id="productName" class="form-control" type="text" name="productName" placeholder="Enter product name" required>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-12">
                ...
                <textarea id="productDescription" class="form-control" name="productDescription" rows="3" placeholder="Enter product description"></textarea>
            </div>
        </div>
        ...
        <div class="button-row d-flex justify-content-center mt-4">
            <button id="saveProduct" class="btn bg-gradient-dark mb-0 js-btn-next" type="button" title="Submit">Submit</button>
        </div>
