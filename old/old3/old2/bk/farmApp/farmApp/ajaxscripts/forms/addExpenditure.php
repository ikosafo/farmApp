...
<form autocomplete="off" id="farmExpenditureForm">
    <div class="card p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
        ...
        <p class="mb-0 text-sm">Add new farm expenditure</p>
        ...
        <div class="row mt-3">
            <div class="col-12">
                ...
                <textarea id="expenditureDescription" class="form-control" name="expenditureDescription" rows="3" placeholder="Enter expenditure description"></textarea>
            </div>
        </div>
